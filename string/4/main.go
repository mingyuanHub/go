...
func main(){
	fmt.Println("6.8" > "6.7")
	fmt.Println("6.08" > "6.7")
	fmt.Println("6.08.2" > "6.07.2")
	fmt.Println("v6.08.3" > "7.09.2")

	fmt.Println(VersionCompare("v6.08.3", "7.09.2", ">"))
	fmt.Println(VersionCompare("7.09.3", "7.09.2", ">"))
}
