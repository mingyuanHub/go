...
require (
	...
	github.com/ryandeng/goversion v0.0.0-20170512051740-b7598d69f662 // indirect
	...
	k8s.io/apimachinery v0.19.0-alpha.3 // indirect
	k8s.io/client-go v0.19.0-alpha.3 // indirect
